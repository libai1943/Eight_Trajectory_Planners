...
%
% Reference:
% J. Fan, N. Murgovski, and J. Liang, "Efficient Collision Avoidance for
% Autonomous Vehicles in Polygonal Domains," IEEE Transactions on
% Transportation Electrification, vol. 11, no. 2, pp. 5396-5406, Jun. 2025.
%
